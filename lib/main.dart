...
class ValeApp extends StatefulWidget {
  @override
  _ValenzuelaAppState createState() => _ValenzuelaAppState();
}

class _ValenzuelaAppState extends State<ValeApp> {
  @override
...
class _PrincipalState extends State<Principal> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("Consultorio Dental de Manuel"),
        centerTitle: true,
